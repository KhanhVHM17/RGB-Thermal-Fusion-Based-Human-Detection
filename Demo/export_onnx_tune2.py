"""
Export Mid-fusion Progressive Luong2 Tune2 (finetune custom data) sang ONNX.
Chay: cd Demo && python export_onnx_tune2.py

Output: models/fusion_progressive_tune2.onnx
"""
...
CHECKPOINT = os.path.join(ROOT_DIR, 'Mid-fusion', 'outputs', 'progressive_luong2_tune1', 'seed_42', 'fusion_best.pt')
...
OUTPUT_ONNX = os.path.join(BASE_DIR, 'models', 'fusion_progressive_tune2.onnx')
IMG_SIZE = 640
